...
namespace EventPlusAPI.Context
{
    public class Eventos_Context : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server = NOTE08-S28\\SQLEXPRESS; Database = Event_Plus; User Id = sa; Pwd = Senai@134; TrustServerCertificate=true;");
            }
        }
